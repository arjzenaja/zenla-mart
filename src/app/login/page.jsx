    ...
    <section className='py-10 w-full  bg-gray-100 flex items-center justify-center relative overflow-hidden'>
      <div className='container'>
        <div className='bg-white p-10 rounded-md shadow-md w-[500px] m-auto'>
          <h1 className='text-center text-[20px] font-[500] text-gray-800 mb-4'>Login to your account</h1>
          ...
          <div className='py-1'>
            <Link href={"/forgot-password"} className='text-[16px] font-[500] text-gray-700 hover:text-primary'>Forgort Password</Link>
          </div>
          ...
          <div className='text-center text-[15px] text-gray-600 mb-3'>
            <span>Not Registered? <Link href={'/register'} className='text-primary hover:text-secondary font-[600]'>Sign Up</Link></span>
          </div>
